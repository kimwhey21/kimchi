...
# 프리뷰는 2026-09-16부터 **어젯밤 마감 + 오늘 밤 일정**을 한 편에 담는다(사용자 결정) —
# 미국장 시황과 합친 글이라 문턱도 시황 쪽으로 올렸다. 얇아지면 합칠 이유가 없어진다.
SERIES_LIMITS = {"프리뷰": {"graphics": 8}, "주간 결산": {"graphics": 4}, "다음 주 일정": {"graphics": 3},
