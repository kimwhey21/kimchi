...
_NEVER_USED = {
    ...
    # 2026-09-09 — 사용자: "'넉 달 만에'는 틀리진 않지만 올드한 표현, 금지". 재테크농부 108편은 숫자로 쓴다(4개월, 5거래일).
    "넉 달": "옛말투입니다(벤치마크 0회). `4개월 만에`처럼 숫자로 쓰세요.",
    "넉달": "옛말투입니다(벤치마크 0회). `4개월 만에`처럼 숫자로 쓰세요.",
    "석 달": "옛말투입니다(벤치마크 0회). `3개월`로 쓰세요.",
    "닷새": "옛말투입니다(벤치마크 0회). `5거래일`·`5일`로 쓰세요.",
    # 2026-09-09 — 사용자: "'볼 것 셋' 말고 '볼 것 세 가지'".
    "것 셋": "`볼 것 세 가지`로 쓰세요(사용자 지시, 2026-09-09).",
    "것 둘": "`볼 것 두 가지`로 쓰세요(사용자 지시, 2026-09-09).",
    "것 넷": "`볼 것 네 가지`로 쓰세요(사용자 지시, 2026-09-09).",
    # 2026-09-26 — 사용자: "'같은 잣대를 댔습니다'는 표현이 아주 어색해, 다시는 쓰지 마라". 벤치마크 155편에
    # '잣대를 대다'는 0회(명사 '잣대'는 2회). 뉴스는 `같은 기준을 적용했습니다`·`같은 기준으로 봤습니다`로 쓴다.
    "잣대를 대": "'잣대를 대다'는 어색한 표현입니다(벤치마크 155편에 0회, 사용자가 금지). `같은 기준을 적용했습니다`·`같은 기준으로 봤습니다`로 쓰세요.",
    "잣대를 댔": "'잣대를 대다'는 어색한 표현입니다(벤치마크 155편에 0회, 사용자가 금지). `같은 기준을 적용했습니다`·`같은 기준으로 봤습니다`로 쓰세요.",
    "잣대를 댄": "'잣대를 대다'는 어색한 표현입니다(벤치마크 155편에 0회, 사용자가 금지). `같은 기준을 적용했습니다`·`같은 기준으로 봤습니다`로 쓰세요.",
}
