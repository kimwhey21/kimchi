...
_AWKWARD_PATTERNS: tuple[tuple[re.Pattern[str], str], ...] = (
    ...
    (
        # 가격 수준을 '…한 자리입니다'로 끝내는 버릇. 2026-09-07 한국장 원고의
        # "7,000선까지 4.61포인트가 남은 자리입니다"를 사용자가 어색하다고 짚었고,
        # 같은 날 "1년 11개월 만의 자리입니다", 9/4 미국장의 "되돌린 자리입니다"·
        # "더 빠진 자리입니다"까지 같은 틀이었다. '자리'는 지위("최대주주 자리")나
        # 장소일 때만 자연스럽고, 수준·가격을 뜻하면 동사로 끝내야 한다 —
        # "7,000선까지는 4.61포인트가 남았습니다", "1년 11개월 만에 보는 수준입니다".
        # 지위·장소의 '자리'는 앞에 이런 서술어가 오지 않으므로 걸리지 않는다.
        re.compile(
            r"(?:남은|남긴|되돌린|반납한|빠진|내린|오른|올라선|넘어선|회복한|되찾은|만의)"
            r"\s*자리(?:입니다|이다|였습니다|였다|다)(?=[.!?,\s]|$)"
        ),
        "가격·수준을 '…한 자리입니다'로 끝내지 마세요. "
        "'7,000선까지는 4.61포인트가 남았습니다'처럼 동사로 끝내거나 '수준'으로 쓰세요.",
    ),
)
...
_NEVER_USED = {
    # 2026-09-08 — 사용자: "AI 같은 표현은 안 된다". 재테크농부 107편 본문 전체에 0회.
    "되밀": "'되밀리다'는 107편에 0회입니다. `멈췄습니다`·`넘지 못했습니다`·`밀렸습니다`로 쓰세요.",
    "갈린 반응": "107편에 0회입니다. `반응이 갈렸습니다`처럼 문장으로 쓰세요.",
    "물러나자": "시장·금리를 사람처럼 '물러나게' 하는 의인화입니다(107편에 0회). `금리 기대가 낮아지자`.",
    "돈이 간 곳": "107편에 0회입니다. `자금이 몰린 곳은`·`가장 많이 산 것은`.",
    "반대편": "약세·부진·반대로를 쓰세요 (본문 60편·제목 1,089개에 0회).",
    "코앞": "제목 1,089개에 0회입니다.",
    "문턱": "제목 1,089개에 0회입니다.",
    # 2026-09-09 — 사용자: "'등락률이 세 배 갈렸습니다', '반대로 눌렸습니다' 표현 이상해, 다신 안 쓰게".
    "눌렸": "주가가 '눌리다'는 시황 은어입니다(벤치마크 108편에 3회뿐, 사용자가 금지). `하락했습니다`·`밀렸습니다`로 쓰세요.",
    "눌리": "주가가 '눌리다'는 시황 은어입니다(벤치마크 108편에 3회뿐, 사용자가 금지). `하락했습니다`·`밀렸습니다`로 쓰세요.",
    "배 갈렸": "등락률은 '갈리지' 않습니다. `다우가 나스닥보다 세 배 넘게 빠졌습니다`처럼 무엇이 얼마나 더 움직였는지로 쓰세요.",
    "배 갈린": "등락률은 '갈리지' 않습니다. `다우가 나스닥보다 세 배 넘게 빠졌습니다`처럼 무엇이 얼마나 더 움직였는지로 쓰세요.",
}
