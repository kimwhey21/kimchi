...
OWNER_PICKS = (
    ...
    "디어 사상 최고가, 11월 25일 실적이 답한다",   # 사장님이 직접 고쳐 준 제목(2026-09-09)
)
...
SECTION_FLOORS = {"시황": 8, "기준표": 5, "프리뷰": 10, "가이드": 5,   # 프리뷰 10: 2026-09-17 메인 글로 확대
                  "주간 결산": 5, "다음 주 일정": 4,   # 주말 편성(2026-09-12)
                  "Guide": 5, "이벤트": 4,             # 유입 편성(2026-09-12): 영어 가이드·이벤트 글
                  "매거진": 4}                       # 두 번째 네이버 블로그(2026-09-13)
